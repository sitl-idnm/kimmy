...
_tmr.push({id: "3747425", type: "pageView", start: (new Date()).getTime()});
(function (d, w, id) {
  ...
  if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); }
      ...
      <body className={`${inter.variable} ${manrope.variable}`} suppressHydrationWarning>
        ...
        <noscript>
          ...
          <div><img src="https://top-fwz1.mail.ru/counter?id=3747425;js=na" style={{ position: 'absolute', left: '-9999px' }} alt="Top.Mail.Ru" /></div>
        </noscript>
